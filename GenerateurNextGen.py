...
#25x25x128
Generator.add(Conv2D(1024, kernel_size=(2, 2), padding='same', activation="relu"))
Generator.add(UpSampling2D(size=(2, 2)))
Generator.add(BatchNormalization(momentum=0.1, epsilon=1e-05))
Generator.add(LeakyReLU())
#50x50x64

Generator.add(Conv2D(512, kernel_size=(2, 2), padding='same', activation="relu"))
Generator.add(UpSampling2D(size=(2, 2)))
Generator.add(BatchNormalization(momentum=0.1, epsilon=1e-05))
Generator.add(LeakyReLU())

Generator.add(Conv2D(256, kernel_size=(2, 2), padding='same', activation="relu"))
Generator.add(UpSampling2D(size=(2, 2)))
Generator.add(BatchNormalization(momentum=0.1, epsilon=1e-05))
Generator.add(LeakyReLU())
...
while CycleActuel < cycle:
    ...
    print()
    print()
    Discriminator.fit(Images_Entrainement, Labels_Entrainement, epochs=1, batch_size=64)
